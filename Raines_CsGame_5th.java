	...
	class Game {
		...
		public void Intro(Pane root,Scene scene) {
			...
			try (InputStream is = Files.newInputStream(
					Paths.get("/home/abram/NetBeansProjects/Raines_CsGame_5th/src/raines_csgame_5th/pics/goodmemes3.jpg"))) {
				try (InputStream is1 = Files.newInputStream(
						Paths.get("/home/abram/NetBeansProjects/Raines_CsGame_5th/src/raines_csgame_5th/pics/713039e6-7c91-4704-8877-1be252deac99.png"))) {

					text[0] = "Welcome to Cast Tech I hope you enjoy your self.";
					text[1] = "Your first class of the day is Spanish 2! ";
					text[2] = "You better get going you are almost late its 8:25!";
					text[3] = "Follow cast_memes";
                                        text[4] = "good memes.png";
...
//			this.sprite.setY(this.getY());
	...
	class Menu {
		...
		public Menu(Pane root,Scene scene) {
			...
			try (InputStream is = Files.newInputStream(
					Paths.get("/home/abram/NetBeansProjects/Raines_CsGame_5th/src/raines_csgame_5th/pics/memed-io-output.jpeg"))) {
				try (InputStream is1 = Files.newInputStream(Paths
						.get("/home/abram/NetBeansProjects/Raines_CsGame_5th/src/raines_csgame_5th/pics/memed-io-output.jpeg"))) {
	...
	class LoadingScreen {
		...
		public LoadingScreen(Pane root,Scene scene) {
			...
			try (InputStream is = Files.newInputStream(
					Paths.get("/home/abram/NetBeansProjects/Raines_CsGame_5th/src/raines_csgame_5th/pics/gooodmems2.jpg"))) {
				try (InputStream is1 = Files.newInputStream(Paths.get(
						"/home/abram/NetBeansProjects/Raines_CsGame_5th/src/raines_csgame_5th/pics/713039e6-7c91-4704-8877-1be252deac99.png"))) {
